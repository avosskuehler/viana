...
namespace VianaNET.Modules.Video.Dialogs
{
  ...
  public partial class SaveVideoDialog : Window
  {
    ...
    private void InitializeDeviceCombo()
    {
      ...
      // Load the listbox with video input device names
      this.CameraComboBox.ItemsSource = DShowUtils.GetVideoInputDevices();
    ...
    {
      this.liveVideoController.SelectDevice((DsDevice)this.CameraComboBox.SelectedValue, this.VideoHost);
    ...
    {
      var camera = (DsDevice)this.CameraComboBox.SelectedValue;
      DShowUtils.DisplayPropertyPage(IntPtr.Zero, (IBaseFilter)camera);
    }
