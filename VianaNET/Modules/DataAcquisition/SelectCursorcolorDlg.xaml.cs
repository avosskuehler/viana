// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SelectCursorcolorDlg.xaml.cs" company="Freie Universität Berlin">
//   ************************************************************************
...
namespace VianaNET.Modules.DataAcquisition
{
  ...
  /// </summary>
  public partial class SelectCursorcolorDlg
  {
    /// <summary>
    ///   Initializes a new instance of the <see cref="SelectCursorcolorDlg" /> class.
    /// </summary>
    public SelectCursorcolorDlg()
    {
