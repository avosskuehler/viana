...
namespace VianaNET.Data
{
  ...
  public class Calibration : DependencyObject, INotifyPropertyChanged
  {
    ...
    public static readonly DependencyProperty ClipRegionProperty = DependencyProperty.Register(
      "ClipRegion", typeof(Rect), typeof(Calibration), new FrameworkPropertyMetadata(default(Rect), OnPropertyChanged));
    ...
    /// <summary>
    ///   Prevents a default instance of the <see cref="Calibration" /> class from being created. 
