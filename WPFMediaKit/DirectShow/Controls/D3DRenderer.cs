...
namespace WPFMediaKit.DirectShow.Controls
{
  ...
  {
    public event EventHandler D3DImageChanged;

    private void OnD3DImageChanged()
    {
      if (this.D3DImageChanged != null)
      {
        this.D3DImageChanged(this, EventArgs.Empty);
      }
    }
    ...
    {
      get { return this.VideoImage.ActualWidth; }
    }

    public double UniformHeight
    {
      get { return this.VideoImage.ActualHeight; }
    }
